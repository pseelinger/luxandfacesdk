...
{
    int res = FSDKE_OK; 
    res = FSDK_ActivateLibrary((char *)"icB/ExV1a/KMgqIy/nBStzbfiZZzgHiV+XaK9iJN+DhwVgrVyC1X2EeH8rmM8okUzLGuhOa5aYegcdqtTiTyOQoxOpOa1+Esh+zj5AyEBmQjzQ+S8RNC7FMVCNOQW3MplfUaDFugFS3PqRAbAbKwEJ0gCadZFNcOipkZGfo/DCk=");
#if defined(DEBUG)
